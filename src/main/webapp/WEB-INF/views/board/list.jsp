...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="row">
			  ...
			  </div> <!-- 우리가 가져온 부트스트랩의 규칙 div class= "col-Lg_12" -->
			</div>   <!-- 우리가 가져온 부트스트랩의 규칙 div class ="row"  -->
	...
	<%-- 					<c:if test="${pageMaker.last }">
							...
							<li class="paginate_button"><a class="page-link"
								href="${pageMaker.endPage}">Last</a></li>
						</c:if> --%>
					</ul>
				</div>
			...
			$(document).ready(function(){
				var result = '<c:out value="${result}"/>';
			 	...
			 	$("#regBtn").on("click",function(){
			 		self.location ="/board/register;" //원래 있던 창을 저 창으로 바꾸는거임
			 	});
